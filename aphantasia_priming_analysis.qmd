...
# Further correlational exploration {#sec-further}
...
#| echo: true
#| code-summary: "Computing the model-based Congruence effects per subject"

# --- Estimating the congruence effect for each subject based on random slope models ---
...
## New exploration of the continuous variables

As mentioned in the code above, we selected a specific set of variables to pursue the exploratory process, that is, *continuous variables* (besides the aphantasia grouping, that could be useful for comparison against the conventional framework)
