...
Out of the box, response times below 300ms and above 3000ms will be removed as they could represent false alarms in regards to standard RTs, along with error trials. This amounts to 5.3% of trials in both tasks. The descriptive statistics of the response times for the remaining trials in both tasks are shown in @tbl-rt_stats.
