...
cor_test(df_questionnaires, "vviq80", "suis60") %>% plot
cor_test(df_questionnaires, "vviq80", "osiq_o75") %>% plot
cor_test(df_questionnaires, "vviq80", "osiq_s75") %>% plot
cor_test(df_questionnaires, "osiq_o75", "osiq_s75") %>% plot
