...
mod_explicit_2b <-
  workflow_explicit_b %>% add_model(
    mod_0_lmer,
    formula = rt_explicit ~ visual_imagery + spatial_imagery + congruence + color + (1|subjectid)
  )
...
mod_explicit_4b <-
  workflow_explicit_b %>% add_model(
    mod_0_lmer,
    formula = rt_explicit ~ visual_imagery * spatial_imagery * congruence * color + (1 + congruence|subjectid)
  )
...
mod_explicit_5b <-
  workflow_explicit_b %>% add_model(
    mod_0_lmer,
    formula = rt_explicit ~ visual_imagery * spatial_imagery * congruence * color + (1 + color|subjectid)
  )
...
mod_explicit_6b <-
  workflow_explicit_b %>% add_model(
    mod_0_lmer,
    formula = rt_explicit ~ visual_imagery * spatial_imagery * congruence * color + 
      (1 + congruence|subjectid) + (1 + color|subjectid)
  )
...
mod_implicit_2b <-
  workflow_implicit_b %>% add_model(
    mod_0_lmer,
    formula = rt_implicit ~ visual_imagery + spatial_imagery + congruence + color + (1|subjectid)
  )
...
mod_implicit_4b <-
  workflow_implicit_b %>% add_model(
    mod_0_lmer,
    formula = rt_implicit ~ visual_imagery * spatial_imagery * congruence * color + (1 + congruence|subjectid)
  )
...
mod_implicit_5b <-
  workflow_implicit_b %>% add_model(
    mod_0_lmer,
    formula = rt_implicit ~ visual_imagery * spatial_imagery * congruence * color + (1 + color|subjectid)
  )
...
mod_implicit_6b <-
  workflow_implicit_b %>% add_model(
    mod_0_lmer,
    formula = rt_implicit ~ visual_imagery * spatial_imagery * congruence * color + 
      (1 + congruence|subjectid) + (1 + color|subjectid)
  )
```
...
all_b_models_parameters[["implicit_b_mods"]][["mod_implicit_5b"]]
```
