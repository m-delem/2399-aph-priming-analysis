...
saveRDS(best_glmm_explicit, "analyses-results/best_glmm_explicit_5MADs.RDS") # readRDS to import
saveRDS(best_glmm_implicit, "analyses-results/best_glmm_implicit_5MADs.RDS")
```
