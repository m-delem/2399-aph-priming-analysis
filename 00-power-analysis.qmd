...
Creates a dataframe with no response data, but whose structure reflects the dataset that will be collected. 
...
### Calculate regression coefficients from cell means
...
# saveRDS(simulations_table, file = "analyses-results/00-power-analyses-table.RDS")
```
